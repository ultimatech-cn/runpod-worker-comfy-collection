...
def process_output_images(outputs, job_id):
    ...
    COMFY_TEMP_PATH = "/root/comfy/ComfyUI/temp"
            ...
            for image in node_output["images"]:
                ...
                if os.path.exists(local_image_path):
                    ...
                    if os.path.exists(temp_image_path):
                        image = base64_encode(temp_image_path)
                        print(
                            "runpod-worker-comfy - the image was found in temp and converted to base64"
                        )
                        output_data.append(
                            {
                                "filename": filename,
                        ...
                        print(f"worker-comfyui - Encoded {filename} as base64 from temp")
                    else:
                        print(
                            f"runpod-worker-comfy - the image does not exist in output or temp folder: {local_image_path}")
                        continue
